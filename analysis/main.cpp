...
int main(int argc, char **argv)
{
    ...
    zebrafish::compute_analysis(V, F, out, E, nu, offset, radius_edge_ratio, min_area, discr_order, is_linear, n_refs, vismesh_rel_area, upsample, markerRCMap, 0, 0, 0, 0, 0, 0, false);
